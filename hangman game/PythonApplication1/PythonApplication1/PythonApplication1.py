...
def letter_pressed(letter, width, height, letters_guessed,):
    match str(letter):
        case 'q': index = 26
        case 'w': index = 27
        case 'e': index = 28
    ...
    button_spawn(root, col_buttons, letter_guessed,
...
def keyboard_spawn(letter, x, y, width, height, colour):
    ...
    keyboard = tk.Button(root,
                        text = letter,
                        font = font,
                        command = lambda: letter_pressed(letter, width, height),
                        bg = colour)
    keyboard.place(x=x,
                   y=y,
                   width=width,
...
def menu_screen():
    ...
    #i could have made them mor eeficient with less code but idc
